...
local function LoadSkin()
	...
	S:HandleCheckBox(AtlasLootItemsFrame_Thunderforged)
	S:HandleCheckBox(AtlasLootItemsFrame_Flexible)
	...
	AtlasLootItemsFrame_BonusRoll:SetTemplate()
	AtlasLootItemsFrame_BonusRoll:Size(25)
	AtlasLootItemsFrame_BonusRoll:StyleButton()
	AtlasLootItemsFrame_BonusRollIcon:SetTexCoord(unpack(E.TexCoords))
	AtlasLootItemsFrame_BonusRollIcon:SetInside()
	...
	AtlasLootItemsFrame_EncounterJournalIcon:SetTexCoord(unpack(E.TexCoords))
	...
	AtlasLootDefaultFrame_EncounterJournalIcon:SetInside()
